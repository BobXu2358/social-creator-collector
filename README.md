...
- **B站**（纯 HTTP）：登录校验、涨粉趋势 + 单稿数据（播放/涨粉/投币/评论/点赞）、**单稿留存曲线 + 完播/平均观看 + 关注非关注播放占比**（稿件分析）、粉丝来源、视频评论、弹幕峰值分析。
...
python -m collector bilibili video-detail --account xgame --bvid BVxxx   # 单稿留存/完播/观众
